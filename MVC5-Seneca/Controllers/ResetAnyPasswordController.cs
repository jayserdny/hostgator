...
namespace MVC5_Seneca
{
    ...
    {  
        ...
        public ActionResult Index()
        {
            ...
            {
                items.Add(new SelectListItem { Value = item.Id.ToString(), Text = item.Name + ": " + item.FirstName + " " + item.LastName }); 
            }
            model.Users = items;
            return View(model);
        }             
        ...
        {
            User user = (from u in db.Users where u.Id == Id select u).Single();
