...
namespace MVC5_Seneca
{
    ...
    //            vm.User = (from u in db.OldUsers where u.Id == userRole.User.Id select u).Single();
    //            viewModel.Add(vm);
    //        }
    ...
    //        foreach (UserDetail user in db.OldUsers.ToList()) 
    //        {
    ...
    //            UserDetail user = (from u in db.OldUsers where u.Id == model.User.Id select u).Single();
    //            model.User = user;             
